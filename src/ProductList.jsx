...
function ProductList({ onHomeClick }) {
        ...
        <div>
            <div className="navbar" style={styleObj}>
                ...
                <div style={styleObjUl}>
                    ...
                    <div> <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}><h1 className='cart' style={{ display: 'flex', alignItems: 'center', color: 'white' }}>
  ...
  {cartQuantity > 0 && (
    <span style={{ marginLeft: '5px', fontSize: '24px', fontWeight: 'bold', color: 'white' }}>
      {cartQuantity}
    </span>
  )}
</h1>
