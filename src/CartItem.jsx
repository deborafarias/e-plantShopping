...
const CartItem = ({ onContinueShopping }) => {
  ...
  const calculateTotalAmount = (cart) => {
    ...
    cart.forEach((item) => {
      const cost = parseFloat(item.cost.substring(1)); // Convierte "$10.00" en 10.00
  ...
  // Maneja la acción de "Seguir Comprando"
  ...
  // Calcula el costo total basado en la cantidad de un artículo
